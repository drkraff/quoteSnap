...
Re-check GitHub before treating anything else as landed. This briefing includes merged PRs through **#50** (draft price_source flags) plus thin option groups (design §8) in this tree.
