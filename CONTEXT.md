...
Re-check GitHub before treating anything else as landed. This briefing includes merged PRs through **#58** (thin old-quote import). **Material cost × markup compute** (design §7 Computed) is in this tree.
