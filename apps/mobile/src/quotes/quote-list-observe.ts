 ...
 * customer_phone / voice_job_id writes would otherwise stay invisible until
 * another quote is created or the screen remounts (FlatList also skips cells
 * when the Model instance identity is unchanged).
 */
