...
export const INSERT_VOICE_LINE_ITEM_SQL = `INSERT INTO quote_line_items (quote_id, catalog_item_id, name, quantity, unit_price_cents, confidence, unit) VALUES ($1, $2, $3, $4, $5, $6, $7)`;
